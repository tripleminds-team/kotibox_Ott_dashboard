      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <div className="relative">
          ...
          <Input placeholder="Search plans..."
            ...
            className="pl-9 w-52 bg-card border-border text-foreground placeholder:text-zinc-500 focus:border-primary h-10 rounded-lg text-sm" />
        </div>
          ...
          <Table>
            <TableHeader>
              <TableRow className="border-border bg-card hover:bg-card">
                ...
                <TableHead className="text-zinc-400 font-semibold text-xs uppercase tracking-wide">Name</TableHead>
                <TableHead className="text-zinc-400 font-semibold text-xs uppercase tracking-wide">Duration</TableHead>
                <TableHead className="text-zinc-400 font-semibold text-xs uppercase tracking-wide">Level</TableHead>
                <TableHead className="text-zinc-400 font-semibold text-xs uppercase tracking-wide">Price</TableHead>
                <TableHead className="text-zinc-400 font-semibold text-xs uppercase tracking-wide">Discount</TableHead>
                <TableHead className="text-zinc-400 font-semibold text-xs uppercase tracking-wide">Total</TableHead>
                <TableHead className="text-zinc-400 font-semibold text-xs uppercase tracking-wide min-w-[160px]">Description</TableHead>
                <TableHead className="text-zinc-400 font-semibold text-xs uppercase tracking-wide">Status</TableHead>
                <TableHead className="text-zinc-400 font-semibold text-xs uppercase tracking-wide text-right pr-5">Action</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {isLoading ? (
                ...
                paginated.map((plan) => (
                  <TableRow key={plan.id} className="border-border hover:bg-muted/30 transition-colors">
                    ...
                    <TableCell className="max-w-[200px]">
                      <p className="text-zinc-400 text-xs truncate" title={plan.description}>
                        {plan.description || <span className="text-zinc-600">—</span>}
                      </p>
                    </TableCell>
                    <TableCell>
        ...
        <AlertDialogContent className="bg-card border border-border text-foreground">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="text-muted-foreground">
              ...
              <span className="font-semibold text-zinc-200">"{confirmDelete?.name}"</span>?
