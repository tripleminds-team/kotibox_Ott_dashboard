      ...
      <div className="flex-1 w-full max-w-4xl mx-auto px-4 sm:px-8 pt-28 pb-12">
        ...
        <div className="relative mb-8">
          ...
          <input
            ...
            className="w-full bg-white/[0.02] border border-white/5 focus:border-primary text-white placeholder:text-zinc-200 pl-12 pr-4 py-4 rounded-2xl text-sm font-semibold focus:outline-none focus:ring-1 focus:ring-primary transition-all backdrop-blur-md"
          />
        </div>
        ...
        {isLoading ? (
          ...
          <div className="text-center py-16 bg-white/[0.01] border border-white/5 rounded-2xl p-8 mb-8">
            <HelpCircle className="w-12 h-12 text-zinc-200 mx-auto mb-3 opacity-40" />
            <h3 className="text-white font-bold text-lg mb-1">No results found</h3>
            <p className="text-zinc-200 text-sm max-w-sm mx-auto">
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <ChevronDown
                      className={`w-4 h-4 text-zinc-300 transition-transform duration-300 ${
                  ...
                  >
                    <p className="p-5 text-zinc-200 text-xs sm:text-sm leading-relaxed whitespace-pre-line bg-zinc-950/20">
                      {faq.answer}
                    </p>
                  </div>
                </div>
