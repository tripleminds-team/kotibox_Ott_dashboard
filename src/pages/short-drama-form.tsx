...
export default function ShortDramaForm() {
  ...
  const isCreate = location === "/short-dramas/new";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (isCreate) {
        ...
        formDataToSend.append("type", "shortdrama");
        ...
        toast({ title: "Short Drama created successfully! HLS processing started in background." });
        ...
        toast({ title: "Short Drama updated successfully!" });
        queryClient.invalidateQueries({ queryKey: ["content-list"] });
  ...
  if (!isCreate && isLoading) {
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        <p className="text-muted-foreground">Loading short drama...</p>
      </div>
    );
  }
    ...
    <div className="max-w-5xl mx-auto">
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="text-3xl font-bold tracking-tight">
            {isCreate ? "Add New Short Drama" : "Edit Short Drama"}
          </h1>
          <p className="text-muted-foreground mt-1">
            {isCreate
              ? "Upload a video to create a new short drama with episodes"
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            <Card className="rounded-lg shadow-sm">
              <CardHeader>
                ...
                <CardDescription>Core information about your short drama</CardDescription>
              </CardHeader>
                  ...
                  {!isCreate && (
                    <div className="flex items-center justify-between rounded-md border border-border p-3">
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground">Set short drama as active</p>
                      </div>
                      <Switch
                        id="status"
            ...
            <Card className="rounded-lg shadow-sm">
              <CardHeader>
                ...
                <CardDescription>Thumbnail for your short drama</CardDescription>
              </CardHeader>
              ...
              <>
                ...
                <Card className="rounded-lg shadow-sm">
                  <CardHeader>
                    ...
                    <CardDescription>
                      Upload your short drama video to split into episodes
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-8">
                    <div className="space-y-4">
          ...
          <div className="space-y-6">
            <Card className="rounded-lg shadow-sm">
              <CardHeader>
                ...
                <CardDescription>
                  Select which categories this short drama appears in
                </CardDescription>
              </CardHeader>
        ...
        <div className="flex justify-end gap-4 pt-4">
          <Button type="button" variant="ghost" onClick={() => setLocation("/short-dramas")}>
            Cancel
          </Button>
          <Button
            type="submit"
          ...
          >
            {isCreate ? "Create Short Drama" : "Save Changes"}
          </Button>
        </div>
      </form>
    </div>
