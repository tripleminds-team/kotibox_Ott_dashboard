  ...
  return (
    <div className="space-y-5 pb-6">
      ...
      <div className="flex items-center gap-2 text-sm text-white/75">
        <button onClick={() => setLocation("/tv-shows")} className="hover:text-white transition-colors">
          Dashboard
        </button>
        <span>/</span>
        <button onClick={() => setLocation("/tv-shows")} className="hover:text-white transition-colors">
        ...
        <span>/</span>
        <span className="text-white font-medium">{isEdit ? "Edit TV Show" : "New TV Show"}</span>
      </div>
      ...
      <div className="rounded-xl border border-border bg-card">
        ...
        {activeTab === "TV Show" && (
          <div className="p-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div className="space-y-1.5">
                <Label className="text-white text-sm font-medium">Content Type</Label>
            ...
            <div className="space-y-1.5">
              ...
              <p className="text-xs text-white/75 pt-1">Select the categories where this show should be manually displayed.</p>
            </div>
          </div>
        )}
