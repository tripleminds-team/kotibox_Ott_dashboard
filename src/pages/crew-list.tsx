  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <Button onClick={() => setLocation("/crew/new")} className="bg-primary hover:bg-primary/90 text-foreground h-10 gap-2 rounded-lg px-5 font-semibold">
        ...
        <Table>
          <TableHeader>
            <TableRow className="border-border bg-card hover:bg-card">
              ...
              <TableHead className="text-zinc-400 font-semibold text-sm">Crew Member</TableHead>
              <TableHead className="text-zinc-400 font-semibold text-sm">Designation</TableHead>
            ...
            {isLoading ? (
              ...
              filtered.map((crew) => (
                <TableRow key={crew.id} className="border-border hover:bg-muted/40">
                  ...
                  <TableCell className="text-zinc-400 text-sm">{crew.designation || "—"}</TableCell>
                  <TableCell>
